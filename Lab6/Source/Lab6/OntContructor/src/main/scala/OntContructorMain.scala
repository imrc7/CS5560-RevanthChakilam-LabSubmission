...
object OntContructorMain {
  def main(args: Array[String]): Unit = {
    ...
    val ONTOLOGYURI="http://www.semanticweb.org/revan/ontologies/2017/6/"
    ...
    val classes=Source.fromFile("C:\\Users\\revan\\Desktop\\Lab6\\CS5560-Tutorial-6-SourceCode\\OntContructor\\data\\Classes").getLines()
    ...
    val subClasses=Source.fromFile("C:\\Users\\revan\\Desktop\\Lab6\\CS5560-Tutorial-6-SourceCode\\OntContructor\\data\\SubClasses").getLines()
    ...
    val objprop=Source.fromFile("C:\\Users\\revan\\Desktop\\Lab6\\CS5560-Tutorial-6-SourceCode\\OntContructor\\data\\ObjectProperties").getLines()
    objprop.foreach(f=> {
      val farr=f.split(",")
    ...
    val dataprop=Source.fromFile("C:\\Users\\revan\\Desktop\\Lab6\\CS5560-Tutorial-6-SourceCode\\OntContructor\\data\\DataProperties").getLines()
    ...
    val individuals=Source.fromFile("C:\\Users\\revan\\Desktop\\Lab6\\CS5560-Tutorial-6-SourceCode\\OntContructor\\data\\Individuals").getLines()
    ...
    val triplets=Source.fromFile("C:\\Users\\revan\\Desktop\\Lab6\\CS5560-Tutorial-6-SourceCode\\OntContructor\\data\\Triplets").getLines()
    triplets.foreach(f=>{
      val farr=f.split(",")
    ...
    val os = new FileOutputStream("C:\\Users\\revan\\Desktop\\Lab6\\CS5560-Tutorial-6-SourceCode\\OntContructor\\data\\family.owl")
