...
object SparkKMeansMain {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val inputPath=Seq("C:\\Users\\revan\\Desktop\\Lab5\\Spark_MachineLearning\\data\\20_news\\*")
    Logger.getRootLogger.setLevel(Level.WARN)

    val topic_output = new PrintStream("C:\\Users\\revan\\Desktop\\Lab5\\Spark_MachineLearning\\data\\Results_KMeans.txt")
  ...
  private def preprocess(sc: SparkContext,paths: Seq[String]): (RDD[(Long, Vector)], RDD[(String,String)], Long) = {
    ...
    //Reading Stop Words
    val stopWords=sc.textFile("C:\\Users\\revan\\Desktop\\Lab5\\Spark_MachineLearning\\data\\stopwords.txt").collect()
